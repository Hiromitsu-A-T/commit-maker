...
const ru: UiStrings = {
  ...
  reasoningLabel: 'Уровень рассуждения (только OpenAI)',
  codexReasoningLabel: 'Уровень рассуждения Codex',
  ...
  statusReady: 'Готово',
  statusError: 'Ошибка',
  badgeUnstagedOn: 'Индексированные + неиндексированные',
  badgeUnstagedOff: 'Только индексированные',
  ...
  providerDescriptionCodex: 'Использует выделенную аутентификацию Codex CLI для Commit Maker.',
  providerDescriptionLocal: 'Использует встроенный runtime llama.cpp с локальной моделью GGUF.',

  codexAuthLabel: 'Аутентификация Codex',
  codexAuthReady: 'Вход в Codex выполнен',
  codexAuthReadyShort: 'вход выполнен',
  codexAuthMissing: 'Вход в Codex не выполнен или Codex не установлен',
  codexAuthMissingShort: 'вход не выполнен',
  codexAuthHint: 'Использует выделенную аутентификацию Codex для Commit Maker, отдельно от обычного входа Codex CLI.',
  codexAuthLoginButton: 'Войти',
  codexAuthRefreshButton: 'Обновить',
  codexAuthLogoutButton: 'Выйти',
  ...
  msgCodexLoginTerminalOpened: 'В терминале запущен выделенный вход Codex для Commit Maker. Статус обновится автоматически после входа.',
  msgCodexLoginFailed: 'Не удалось запустить вход в Codex: {detail}',
  msgCodexLogoutComplete: 'Выполнен выход из выделенной аутентификации Codex для Commit Maker.',
  msgCodexLogoutFailed: 'Не удалось выйти из Codex: {detail}',
  ...
  msgDiffEmpty: 'Различий нет. Проверьте индексированные файлы или изменения.',
  ...
  msgUntrackedReadFailed: 'Не удалось прочитать неотслеживаемый файл: {path} ({detail})',
  msgUntrackedSkipBinary: 'Пропущен неотслеживаемый файл (возможен бинарный): {path}',
  ...
  promptGuard: 'Точно соблюдайте формат и инструкции, указанные пользователем.',
  userInstructionLabel: 'Инструкции пользователя (дословно):',



  diffSectionStaged: '### Индексированные',
  diffSectionUnstaged: '### Неиндексированные',
  diffSectionUntracked: '### Неотслеживаемые {path}',
  diffHeading: '# Различия'
};
