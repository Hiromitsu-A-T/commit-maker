...
const he: UiStrings = {
  ...
  reasoningLabel: 'רמת היסק (רק OpenAI)',
  ...
  localModelLabel: 'מודל',
  localModelDownloadButton: 'הורדת מודל',
  localModelCancelButton: 'ביטול',
  localModelDeleteButton: 'מחיקה',
  localModelTestButton: 'בדיקה',
  localModelStatusNotDownloaded: 'לא הורד',
  localModelStatusDownloading: 'מוריד',
  localModelStatusReady: 'מוכן',
  localModelStatusLoading: 'טוען',
  ...
  includeUnstagedLabel: 'כלול שינויים שלא הוכנו לקומיט',
  ...
  statusReady: 'הושלם',
  statusError: 'שגיאה',
  badgeUnstagedOn: 'מוכנים לקומיט + לא מוכנים',
  badgeUnstagedOff: 'מוכנים לקומיט בלבד',
  ...
  providerDescriptionCodex: 'משתמש באימות Codex CLI ייעודי של Commit Maker.',
  providerDescriptionLocal: 'משתמש ב-runtime המצורף של llama.cpp עם מודל GGUF מקומי.',

  codexAuthLabel: 'אימות Codex',
  codexAuthReady: 'Codex מחובר',
  codexAuthReadyShort: 'מחובר',
  codexAuthMissing: 'Codex לא מחובר או לא מותקן',
  codexAuthMissingShort: 'לא מחובר',
  codexAuthHint: 'משתמש באימות Codex ייעודי של Commit Maker, נפרד מהכניסה הרגילה שלך ל-Codex CLI.',
  codexAuthLoginButton: 'התחברות',
  codexAuthRefreshButton: 'רענון',
  codexAuthLogoutButton: 'התנתקות',
  msgApiKeySaved: 'מפתח API נשמר.',
  msgApiKeySavePick: 'בחר ספק לשמירת מפתח ה‑API',
  msgApiKeyInputPrompt: 'הזן מפתח API עבור {provider}',
  msgCodexLoginTerminalOpened: 'התחברות Codex ייעודית של Commit Maker הופעלה במסוף. הסטטוס יתרענן אוטומטית לאחר ההתחברות.',
  msgCodexLoginFailed: 'הפעלת התחברות Codex נכשלה: {detail}',
  msgCodexLogoutComplete: 'התנתקת מאימות Codex הייעודי של Commit Maker.',
  msgCodexLogoutFailed: 'ההתנתקות מ-Codex נכשלה: {detail}',
  ...
  msgDiffEmpty: 'אין שינויים להשוואה. בדוק קבצים מוכנים לקומיט או שינויים.',
  ...
  msgLlmEmptyLocal: 'תגובת ה-LLM המקומי הייתה ריקה.',
  msgLocalModelMissing: 'המודל המקומי לא הורד.',
  msgLocalModelDownloadComplete: 'המודל המקומי הורד.',
  msgLocalModelDownloadFailed: 'הורדת המודל המקומי נכשלה: {detail}',
  msgLocalModelDownloadCancelled: 'הורדת המודל המקומי בוטלה.',
  msgLocalModelDeleted: 'המודל המקומי נמחק.',
  msgLocalRuntimeMissing: 'runtime של llama.cpp לא נמצא. בדוק את commitMaker.localRuntimePath או את הקבצים הבינאריים המצורפים.',
  msgLocalServerStartFailed: 'הפעלת שרת ה-LLM המקומי נכשלה: {detail}',
  ...
  promptGuard: 'יש לפעול בדיוק לפי הפורמט וההנחיות שהמשתמש ביקש.',
  userInstructionLabel: 'הנחיות המשתמש (כלשונן):',



  diffSectionStaged: '### מוכנים לקומיט',
  diffSectionUnstaged: '### לא מוכנים לקומיט',
