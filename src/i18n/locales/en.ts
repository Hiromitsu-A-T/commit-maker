...
const en: UiStrings = {
  ...
  reasoningLabel: 'Reasoning Effort (OpenAI)',
  ...
  providerDescriptionCodex: 'Uses Commit Maker\'s dedicated Codex authentication through Codex CLI.',
  providerDescriptionLocal: 'Uses the bundled llama.cpp runtime with a local GGUF model.',

  codexAuthLabel: 'Codex authentication',
  codexAuthReady: 'Codex signed in',
  codexAuthReadyShort: 'signed in',
  codexAuthMissing: 'Codex not signed in or not installed',
  codexAuthMissingShort: 'not signed in',
  codexAuthHint: 'Uses Commit Maker\'s dedicated Codex authentication, separate from your normal Codex CLI login.',
  codexAuthLoginButton: 'Sign in',
  codexAuthRefreshButton: 'Refresh',
  codexAuthLogoutButton: 'Sign out',
  ...
  msgCodexLoginTerminalOpened: 'Started Commit Maker\'s dedicated Codex login in the terminal. The status refreshes automatically after sign-in.',
  msgCodexLoginFailed: 'Failed to start Codex login: {detail}',
  msgCodexLogoutComplete: 'Signed out from Commit Maker\'s dedicated Codex authentication.',
  msgCodexLogoutFailed: 'Failed to sign out from Codex: {detail}',
