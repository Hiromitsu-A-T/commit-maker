...
const zhTw: UiStrings = {
  ...
  localModelLabel: '模型',
  localModelDownloadButton: '下載模型',
  localModelCancelButton: '取消',
  localModelDeleteButton: '刪除',
  localModelTestButton: '測試',
  localModelStatusNotDownloaded: '尚未下載',
  localModelStatusDownloading: '下載中',
  localModelStatusReady: '可使用',
  ...
  providerDescriptionCodex: '透過 Commit Maker 專用的 Codex CLI 認證使用。',
  providerDescriptionLocal: '使用內建的 llama.cpp runtime 與本機 GGUF 模型。',

  codexAuthLabel: 'Codex 認證',
  codexAuthReady: 'Codex 已登入',
  codexAuthReadyShort: '已登入',
  codexAuthMissing: 'Codex 未登入或未安裝',
  codexAuthMissingShort: '未登入',
  codexAuthHint: '使用 Commit Maker 專用的 Codex 認證，與一般 Codex CLI 登入分離。',
  codexAuthLoginButton: '登入',
  codexAuthRefreshButton: '重新整理',
  codexAuthLogoutButton: '登出',
  msgApiKeySaved: '已儲存 API 金鑰。',
  msgApiKeySavePick: '請選擇要儲存 API 金鑰的提供者',
  msgApiKeyInputPrompt: '請輸入 {provider} 的 API 金鑰',
  msgCodexLoginTerminalOpened: '已在終端機中啟動 Commit Maker 專用的 Codex 登入。登入後狀態會自動更新。',
  msgCodexLoginFailed: '啟動 Codex 登入失敗：{detail}',
  msgCodexLogoutComplete: '已登出 Commit Maker 專用的 Codex 認證。',
  msgCodexLogoutFailed: 'Codex 登出失敗：{detail}',
  ...
  msgLlmEmptyLocal: '本機 LLM 回應為空。',
  msgLocalModelMissing: '尚未下載本機模型。',
  msgLocalModelDownloadComplete: '已下載本機模型。',
  msgLocalModelDownloadFailed: '下載本機模型失敗：{detail}',
  msgLocalModelDownloadCancelled: '已取消本機模型下載。',
  msgLocalModelDeleted: '已刪除本機模型。',
  msgLocalRuntimeMissing: '找不到 llama.cpp runtime。請檢查 commitMaker.localRuntimePath 或內建二進位檔。',
  msgLocalServerStartFailed: '啟動本機 LLM 伺服器失敗：{detail}',
  ...
  promptGuard: '請嚴格遵循使用者指定的格式與指示。',
  userInstructionLabel: '使用者指示（原文）：',
