...
const sv: UiStrings = {
  ...
  reasoningLabel: 'Resoneringsnivå (endast OpenAI)',
  ...
  includeUnstagedLabel: 'Ta med ej förberedda ändringar',
  ...
  statusReady: 'Klart',
  statusError: 'Fel',
  badgeUnstagedOn: 'Förberedda + ej förberedda',
  badgeUnstagedOff: 'Endast förberedda',
  ...
  providerDescriptionCodex: 'Använder Commit Makers dedikerade Codex CLI-autentisering.',
  ...
  codexAuthReady: 'Codex inloggad',
  codexAuthReadyShort: 'inloggad',
  codexAuthMissing: 'Codex är inte inloggad eller inte installerad',
  codexAuthMissingShort: 'inte inloggad',
  codexAuthHint: 'Använder Commit Makers dedikerade Codex-autentisering, separat från din vanliga Codex CLI-inloggning.',
  codexAuthLoginButton: 'Logga in',
  codexAuthRefreshButton: 'Uppdatera',
  codexAuthLogoutButton: 'Logga ut',
  ...
  msgCodexLoginTerminalOpened: 'Commit Makers dedikerade Codex-inloggning startades i terminalen. Statusen uppdateras automatiskt efter inloggning.',
  msgCodexLoginFailed: 'Kunde inte starta Codex-inloggning: {detail}',
  msgCodexLogoutComplete: 'Utloggad från Commit Makers dedikerade Codex-autentisering.',
  msgCodexLogoutFailed: 'Kunde inte logga ut från Codex: {detail}',
  ...
  msgDiffEmpty: 'Ingen skillnad hittades. Kontrollera förberedda filer eller ändringar.',
  ...
  promptGuard: 'Följ användarens begärda format och instruktioner exakt.',
  userInstructionLabel: 'Användarinstruktioner (ordagrant):',



  diffSectionStaged: '### Förberedda',
  diffSectionUnstaged: '### Ej förberedda',
  diffSectionUntracked: '### Ospårad {path}',
  diffHeading: '# Skillnad'
};
