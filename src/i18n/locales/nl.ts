...
const nl: UiStrings = {
  ...
  reasoningLabel: 'Redeneerinspanning (alleen OpenAI)',
  codexReasoningLabel: 'Codex-redeneerinspanning',
  ...
  providerLabelLocal: 'Lokale LLM',
  localModelLabel: 'Lokaal model',
  localModelDownloadButton: 'Model downloaden',
  localModelCancelButton: 'Annuleren',
  localModelDeleteButton: 'Verwijderen',
  localModelTestButton: 'Testen',
  localModelStatusNotDownloaded: 'Niet gedownload',
  localModelStatusDownloading: 'Downloaden',
  localModelStatusReady: 'Gereed',
  localModelStatusLoading: 'Laden',
  ...
  providerDescriptionCodex: 'Gebruikt Commit Makers eigen Codex CLI-authenticatie.',
  providerDescriptionLocal: 'Gebruikt de meegeleverde llama.cpp-runtime met een lokaal GGUF-model.',

  codexAuthLabel: 'Codex-authenticatie',
  codexAuthReady: 'Codex aangemeld',
  codexAuthReadyShort: 'aangemeld',
  codexAuthMissing: 'Codex niet aangemeld of niet geïnstalleerd',
  codexAuthMissingShort: 'niet aangemeld',
  codexAuthHint: 'Gebruikt Commit Makers eigen Codex-authenticatie, gescheiden van je normale Codex CLI-login.',
  codexAuthLoginButton: 'Aanmelden',
  codexAuthRefreshButton: 'Vernieuwen',
  codexAuthLogoutButton: 'Afmelden',
  ...
  msgCodexLoginTerminalOpened: 'Commit Makers eigen Codex-login is gestart in de terminal. De status wordt na aanmelden automatisch vernieuwd.',
  msgCodexLoginFailed: 'Codex-login kon niet worden gestart: {detail}',
  msgCodexLogoutComplete: 'Afgemeld van Commit Makers eigen Codex-authenticatie.',
  msgCodexLogoutFailed: 'Afmelden bij Codex mislukt: {detail}',
  ...
  msgDiffEmpty: 'Geen verschillen gevonden. Controleer geïndexeerde bestanden of wijzigingen.',
  ...
  msgLlmEmptyLocal: 'De reactie van de lokale LLM was leeg.',
  msgLocalModelMissing: 'Het lokale model is niet gedownload.',
  msgLocalModelDownloadComplete: 'Het lokale model is gedownload.',
  msgLocalModelDownloadFailed: 'Downloaden van het lokale model is mislukt: {detail}',
  msgLocalModelDownloadCancelled: 'Download van het lokale model geannuleerd.',
  msgLocalModelDeleted: 'Het lokale model is verwijderd.',
  msgLocalRuntimeMissing: 'llama.cpp-runtime is niet gevonden. Controleer commitMaker.localRuntimePath of de meegeleverde binaries.',
  msgLocalServerStartFailed: 'Kon de lokale LLM-server niet starten: {detail}',
  ...
  msgUntrackedReadFailed: 'Niet-gevolgd bestand lezen mislukt: {path} ({detail})',
  msgUntrackedSkipBinary: 'Niet-gevolgd bestand overgeslagen (mogelijk binair): {path}',
  ...
  promptGuard: 'Volg het door de gebruiker gevraagde formaat en de instructies precies.',
  userInstructionLabel: 'Gebruikersinstructies (letterlijk):',
