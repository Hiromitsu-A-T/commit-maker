...
Local は llama.cpp の context size を超える大きな差分を分割して要約し、全体要約から最終コミットメッセージを生成します。  
(Local splits oversized diffs into chunks, summarizes them locally, and generates the final commit message from the combined summaries.)
