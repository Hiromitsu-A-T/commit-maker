...
const vi: UiStrings = {
  ...
  reasoningLabel: 'Mức suy luận (chỉ OpenAI)',
  ...
  localModelLabel: 'Mô hình',
  localModelDownloadButton: 'Tải mô hình',
  localModelCancelButton: 'Hủy',
  localModelDeleteButton: 'Xóa',
  localModelTestButton: 'Kiểm tra',
  localModelStatusNotDownloaded: 'Chưa tải',
  localModelStatusDownloading: 'Đang tải',
  localModelStatusReady: 'Sẵn sàng',
  localModelStatusLoading: 'Đang nạp',
  ...
  includeUnstagedLabel: 'Bao gồm thay đổi chưa chuẩn bị',
  ...
  statusError: 'Lỗi',
  badgeUnstagedOn: 'Đã chuẩn bị + chưa chuẩn bị',
  badgeUnstagedOff: 'Chỉ đã chuẩn bị',
  ...
  providerDescriptionCodex: 'Sử dụng xác thực Codex CLI riêng cho Commit Maker.',
  providerDescriptionLocal: 'Dùng runtime llama.cpp đi kèm với mô hình GGUF cục bộ.',

  codexAuthLabel: 'Xác thực Codex',
  codexAuthReady: 'Codex đã đăng nhập',
  codexAuthReadyShort: 'đã đăng nhập',
  codexAuthMissing: 'Codex chưa đăng nhập hoặc chưa cài đặt',
  codexAuthMissingShort: 'chưa đăng nhập',
  codexAuthHint: 'Sử dụng xác thực Codex riêng của Commit Maker, tách biệt với đăng nhập Codex CLI thông thường.',
  codexAuthLoginButton: 'Đăng nhập',
  codexAuthRefreshButton: 'Làm mới',
  codexAuthLogoutButton: 'Đăng xuất',
  ...
  msgCodexLoginTerminalOpened: 'Đã bắt đầu đăng nhập Codex riêng cho Commit Maker trong terminal. Trạng thái sẽ tự động làm mới sau khi đăng nhập.',
  msgCodexLoginFailed: 'Không thể bắt đầu đăng nhập Codex: {detail}',
  msgCodexLogoutComplete: 'Đã đăng xuất khỏi xác thực Codex riêng của Commit Maker.',
  msgCodexLogoutFailed: 'Không thể đăng xuất khỏi Codex: {detail}',
  ...
  msgDiffEmpty: 'Không có khác biệt. Kiểm tra tệp đã chuẩn bị hoặc thay đổi.',
  ...
  msgLlmEmptyLocal: 'Phản hồi của LLM cục bộ bị trống.',
  msgLocalModelMissing: 'Mô hình cục bộ chưa được tải.',
  msgLocalModelDownloadComplete: 'Đã tải mô hình cục bộ.',
  msgLocalModelDownloadFailed: 'Không tải được mô hình cục bộ: {detail}',
  msgLocalModelDownloadCancelled: 'Đã hủy tải mô hình cục bộ.',
  msgLocalModelDeleted: 'Đã xóa mô hình cục bộ.',
  msgLocalRuntimeMissing: 'Không tìm thấy runtime llama.cpp. Kiểm tra commitMaker.localRuntimePath hoặc binary đi kèm.',
  msgLocalServerStartFailed: 'Không khởi động được máy chủ LLM cục bộ: {detail}',
  ...
  promptGuard: 'Hãy làm đúng định dạng và chỉ dẫn mà người dùng yêu cầu.',
  userInstructionLabel: 'Chỉ dẫn của người dùng (nguyên văn):',



  diffSectionStaged: '### Đã chuẩn bị',
  diffSectionUnstaged: '### Chưa chuẩn bị',
  diffSectionUntracked: '### Chưa theo dõi {path}',
  diffHeading: '# Khác biệt'
};
