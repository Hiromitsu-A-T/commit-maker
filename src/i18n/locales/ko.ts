...
const ko: UiStrings = {
  ...
  localModelCancelButton: '취소',
  localModelDeleteButton: '삭제',
  localModelTestButton: '테스트',
  localModelStatusNotDownloaded: '다운로드 안 됨',
  localModelStatusDownloading: '다운로드 중',
  localModelStatusReady: '준비됨',
  localModelStatusLoading: '불러오는 중',
  ...
  msgLlmEmptyLocal: '로컬 LLM 응답이 비어 있습니다.',
  msgLocalModelMissing: '로컬 모델이 다운로드되지 않았습니다.',
  msgLocalModelDownloadComplete: '로컬 모델을 다운로드했습니다.',
  msgLocalModelDownloadFailed: '로컬 모델 다운로드에 실패했습니다: {detail}',
  msgLocalModelDownloadCancelled: '로컬 모델 다운로드를 취소했습니다.',
  msgLocalModelDeleted: '로컬 모델을 삭제했습니다.',
  msgLocalRuntimeMissing: 'llama.cpp 런타임을 찾을 수 없습니다. commitMaker.localRuntimePath 또는 동봉된 바이너리를 확인하세요.',
  msgLocalServerStartFailed: '로컬 LLM 서버 시작에 실패했습니다: {detail}',
