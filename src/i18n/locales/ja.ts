...
const ja: UiStrings = {
  ...
  localModelLabel: 'モデル',
  localModelDownloadButton: 'ダウンロード',
  localModelCancelButton: 'キャンセル',
  localModelDeleteButton: '削除',
  localModelTestButton: 'テスト',
  ...
  providerDescriptionCodex: 'Commit Maker 専用の Codex CLI 認証を利用します。',
  providerDescriptionLocal: '同梱 llama.cpp ランタイムとローカル GGUF モデルを利用します。',

  codexAuthLabel: 'Codex 認証',
  codexAuthReady: 'Codex ログイン済み',
  codexAuthReadyShort: 'ログイン済み',
  codexAuthMissing: 'Codex 未ログインまたは未インストール',
  codexAuthMissingShort: '未ログイン',
  codexAuthHint: 'Commit Maker 専用の Codex 認証を使います。通常の Codex CLI ログインとは分離されます。',
  codexAuthLoginButton: 'ログイン',
  codexAuthRefreshButton: '更新',
  codexAuthLogoutButton: 'ログアウト',

  msgApiKeySaved: 'API キーを保存しました。',
  msgApiKeySavePick: '保存する API キーのプロバイダーを選択してください',
  msgApiKeyInputPrompt: '{provider} の API キーを入力してください',
  msgCodexLoginTerminalOpened: 'Commit Maker 専用の Codex ログインをターミナルで開始しました。完了後に自動更新します。',
  msgCodexLoginFailed: 'Codex ログインの開始に失敗しました: {detail}',
  msgCodexLogoutComplete: 'Commit Maker 専用の Codex 認証をログアウトしました。',
  msgCodexLogoutFailed: 'Codex ログアウトに失敗しました: {detail}',
  ...
  msgLlmEmptyLocal: 'ローカル LLM 応答が空でした。',
  msgLocalModelMissing: 'ローカルモデルが未ダウンロードです。',
  msgLocalModelDownloadComplete: 'ローカルモデルをダウンロードしました。',
  msgLocalModelDownloadFailed: 'ローカルモデルのダウンロードに失敗しました: {detail}',
  msgLocalModelDownloadCancelled: 'ローカルモデルのダウンロードをキャンセルしました。',
  msgLocalModelDeleted: 'ローカルモデルを削除しました。',
  msgLocalRuntimeMissing: 'llama.cpp ランタイムが見つかりません。commitMaker.localRuntimePath または同梱バイナリを確認してください。',
  msgLocalServerStartFailed: 'ローカル LLM サーバーの起動に失敗しました: {detail}',
  ...
  promptGuard: 'ユーザーが指定した書式と指示を厳密に守ってください。',
  userInstructionLabel: 'ユーザー指示（原文）:',
