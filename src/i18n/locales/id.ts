...
const id: UiStrings = {
  ...
  reasoningLabel: 'Tingkat penalaran (hanya OpenAI)',
  ...
  localModelLabel: 'Model lokal',
  localModelDownloadButton: 'Unduh model',
  localModelCancelButton: 'Batal',
  localModelDeleteButton: 'Hapus',
  localModelTestButton: 'Uji',
  localModelStatusNotDownloaded: 'Belum diunduh',
  localModelStatusDownloading: 'Mengunduh',
  localModelStatusReady: 'Siap',
  localModelStatusLoading: 'Memuat',
  ...
  includeUnstagedLabel: 'Sertakan perubahan yang belum disiapkan',
  ...
  generationSectionTitle: 'Pembuatan & hasil',
  generateButton: 'Buat',
  ...
  resultPlaceholder: 'Belum dibuat.',
  resultHint: 'Periksa hasil, lalu klik “Terapkan ke SCM” untuk menyalin ke kotak commit.',
  errorPlaceholder: '-',

  statusIdle: 'Siap',
  statusLoading: 'Membuat dengan LLM…',
  statusReady: 'Selesai',
  statusError: 'Error',
  badgeUnstagedOn: 'Disiapkan + belum disiapkan',
  badgeUnstagedOff: 'Hanya disiapkan',
  ...
  providerDescriptionCodex: 'Menggunakan autentikasi Codex CLI khusus Commit Maker.',
  providerDescriptionLocal: 'Menggunakan runtime llama.cpp bawaan dengan model GGUF lokal.',

  codexAuthLabel: 'Autentikasi Codex',
  codexAuthReady: 'Codex sudah masuk',
  codexAuthReadyShort: 'sudah masuk',
  codexAuthMissing: 'Codex belum masuk atau belum terpasang',
  codexAuthMissingShort: 'belum masuk',
  codexAuthHint: 'Menggunakan autentikasi Codex khusus Commit Maker, terpisah dari login Codex CLI biasa Anda.',
  codexAuthLoginButton: 'Masuk',
  codexAuthRefreshButton: 'Segarkan',
  codexAuthLogoutButton: 'Keluar',
  ...
  msgCodexLoginTerminalOpened: 'Login Codex khusus Commit Maker dimulai di terminal. Status akan otomatis disegarkan setelah masuk.',
  msgCodexLoginFailed: 'Gagal memulai login Codex: {detail}',
  msgCodexLogoutComplete: 'Keluar dari autentikasi Codex khusus Commit Maker.',
  msgCodexLogoutFailed: 'Gagal keluar dari Codex: {detail}',

  msgCommitGenerateTitle: 'Pembuatan pesan commit (Commit Maker)',
  msgCommitGenerateFetchingDiff: 'Mengambil diff…',
  msgCommitGenerateCallingLlm: 'Memanggil LLM…',
  msgCommitGenerateFailedPrefix: 'Gagal membuat pesan commit: ',
  msgCommitApplyProgress: 'Menerapkan ke SCM…',
  msgCommitApplySuccess: 'Pesan commit disalin ke kotak SCM.',
  msgCommitNotGenerated: 'Buat pesan commit terlebih dahulu.',
  msgRepoNotFound: 'Repositori Git tidak ditemukan.',
  msgCancelled: 'Dibatalkan pengguna',
  msgDiffEmpty: 'Tidak ada perbedaan. Periksa file yang disiapkan atau perubahan.',
  ...
  msgLlmEmptyLocal: 'Respons LLM lokal kosong.',
  msgLocalModelMissing: 'Model lokal belum diunduh.',
  msgLocalModelDownloadComplete: 'Model lokal berhasil diunduh.',
  msgLocalModelDownloadFailed: 'Gagal mengunduh model lokal: {detail}',
  msgLocalModelDownloadCancelled: 'Unduhan model lokal dibatalkan.',
  msgLocalModelDeleted: 'Model lokal dihapus.',
  msgLocalRuntimeMissing: 'Runtime llama.cpp tidak ditemukan. Periksa commitMaker.localRuntimePath atau binary bawaan.',
  msgLocalServerStartFailed: 'Gagal memulai server LLM lokal: {detail}',
  ...
  msgUntrackedReadFailed: 'Gagal membaca file yang belum terlacak: {path} ({detail})',
  msgUntrackedSkipBinary: 'Melewati file yang belum terlacak (mungkin biner): {path}',
  ...
  promptGuard: 'Ikuti format dan instruksi yang diminta pengguna secara persis.',
  userInstructionLabel: 'Instruksi pengguna (apa adanya):',



  diffSectionStaged: '### Disiapkan',
  diffSectionUnstaged: '### Belum disiapkan',
  diffSectionUntracked: '### Belum terlacak {path}',
  diffHeading: '# Perbedaan'
};
