...
const it: UiStrings = {
  ...
  apiKeySectionTitle: 'Chiave API / modello',
  ...
  localModelCancelButton: 'Annulla',
  localModelDeleteButton: 'Elimina',
  localModelTestButton: 'Prova',
  localModelStatusNotDownloaded: 'Non scaricato',
  localModelStatusDownloading: 'Download in corso',
  localModelStatusReady: 'Pronto',
  localModelStatusLoading: 'Caricamento',
  localModelStatusError: 'Errore',
  localModelSizePrefix: 'Dimensione: ',
  localModelNeedDownload: 'Scarica prima il modello locale.',
  localModelRecommendedBadge: 'Consigliato',
  localModelRecommendedHint: 'Il miglior equilibrio tra rispetto delle istruzioni e prestazioni locali. Consigliato per l’uso normale.',
  localModelLowMemoryBadge: 'Memoria ridotta',
  localModelLowMemoryHint: 'Usa meno memoria, ma la precisione può diminuire con diff lunghi o complessi e prompt personalizzati dettagliati.',
  ...
  msgLlmEmptyLocal: 'La risposta del LLM locale era vuota.',
  msgLocalModelMissing: 'Il modello locale non è stato scaricato.',
  msgLocalModelDownloadComplete: 'Modello locale scaricato.',
  msgLocalModelDownloadFailed: 'Download del modello locale non riuscito: {detail}',
  msgLocalModelDownloadCancelled: 'Download del modello locale annullato.',
  msgLocalModelDeleted: 'Modello locale eliminato.',
  msgLocalRuntimeMissing: 'Runtime llama.cpp non trovato. Controlla commitMaker.localRuntimePath o i binari inclusi.',
  msgLocalServerStartFailed: 'Avvio del server LLM locale non riuscito: {detail}',
