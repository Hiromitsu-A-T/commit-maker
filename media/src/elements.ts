...
export function queryElements(): PanelElements {
  ...
  return {
    ...
    codexAuthLogin: get('codexAuthLogin') as HTMLButtonElement | null,
    codexAuthRefresh: get('codexAuthRefresh') as HTMLButtonElement | null,
    codexAuthLogout: get('codexAuthLogout') as HTMLButtonElement | null,
