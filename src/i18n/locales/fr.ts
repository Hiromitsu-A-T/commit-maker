...
const fr: UiStrings = {
  ...
  localModelCancelButton: 'Annuler',
  localModelDeleteButton: 'Supprimer',
  localModelTestButton: 'Tester',
  localModelStatusNotDownloaded: 'Non téléchargé',
  localModelStatusDownloading: 'Téléchargement',
  localModelStatusReady: 'Prêt',
  localModelStatusLoading: 'Chargement',
  localModelStatusError: 'Erreur',
  localModelSizePrefix: 'Taille : ',
  localModelNeedDownload: 'Téléchargez d’abord le modèle local.',
  localModelRecommendedBadge: 'Recommandé',
  localModelRecommendedHint: 'Meilleur équilibre entre suivi des instructions et performances locales. Recommandé pour un usage normal.',
  localModelLowMemoryBadge: 'Mémoire réduite',
  localModelLowMemoryHint: 'Utilise moins de mémoire, mais la précision peut baisser sur les diffs longs ou complexes et les prompts personnalisés détaillés.',
  ...
  msgLlmEmptyLocal: 'La réponse du LLM local était vide.',
  msgLocalModelMissing: 'Le modèle local n’a pas été téléchargé.',
  msgLocalModelDownloadComplete: 'Modèle local téléchargé.',
  msgLocalModelDownloadFailed: 'Échec du téléchargement du modèle local : {detail}',
  msgLocalModelDownloadCancelled: 'Téléchargement du modèle local annulé.',
  msgLocalModelDeleted: 'Modèle local supprimé.',
  msgLocalRuntimeMissing: 'Le runtime llama.cpp est introuvable. Vérifiez commitMaker.localRuntimePath ou les binaires inclus.',
  msgLocalServerStartFailed: 'Échec du démarrage du serveur LLM local : {detail}',
