...
const hi: UiStrings = {
  ...
  reasoningLabel: 'तर्क स्तर (केवल OpenAI)',
  codexReasoningLabel: 'Codex तर्क स्तर',
  ...
  providerLabelLocal: 'स्थानीय LLM',
  localModelLabel: 'मॉडल',
  localModelDownloadButton: 'मॉडल डाउनलोड करें',
  localModelCancelButton: 'रद्द करें',
  localModelDeleteButton: 'हटाएँ',
  localModelTestButton: 'परीक्षण',
  localModelStatusNotDownloaded: 'डाउनलोड नहीं हुआ',
  localModelStatusDownloading: 'डाउनलोड हो रहा है',
  localModelStatusReady: 'तैयार',
  localModelStatusLoading: 'लोड हो रहा है',
  ...
  generationSectionTitle: 'बनाना और परिणाम',
  generateButton: 'बनाएँ',
  ...
  providerDescriptionCodex: 'Commit Maker के लिए समर्पित Codex CLI प्रमाणीकरण का उपयोग करता है।',
  providerDescriptionLocal: 'बंडल किए गए llama.cpp runtime और स्थानीय GGUF मॉडल का उपयोग करता है।',

  codexAuthLabel: 'Codex प्रमाणीकरण',
  codexAuthReady: 'Codex में साइन इन है',
  codexAuthReadyShort: 'साइन इन',
  codexAuthMissing: 'Codex में साइन इन नहीं है या इंस्टॉल नहीं है',
  codexAuthMissingShort: 'साइन इन नहीं',
  codexAuthHint: 'Commit Maker के लिए समर्पित Codex प्रमाणीकरण का उपयोग करता है, जो आपके सामान्य Codex CLI लॉगिन से अलग है।',
  codexAuthLoginButton: 'साइन इन',
  codexAuthRefreshButton: 'रीफ्रेश',
  codexAuthLogoutButton: 'साइन आउट',
  ...
  msgCodexLoginTerminalOpened: 'टर्मिनल में Commit Maker का समर्पित Codex लॉगिन शुरू किया गया। साइन इन के बाद स्थिति अपने आप रीफ्रेश होगी।',
  msgCodexLoginFailed: 'Codex लॉगिन शुरू नहीं हो सका: {detail}',
  msgCodexLogoutComplete: 'Commit Maker के समर्पित Codex प्रमाणीकरण से साइन आउट किया गया।',
  msgCodexLogoutFailed: 'Codex से साइन आउट नहीं हो सका: {detail}',

  msgCommitGenerateTitle: 'कमिट संदेश बनाना (Commit Maker)',
  msgCommitGenerateFetchingDiff: 'diff प्राप्त कर रहा है…',
  msgCommitGenerateCallingLlm: 'LLM को पूछ रहा है…',
  msgCommitGenerateFailedPrefix: 'कमिट संदेश बनाने में विफल: ',
  msgCommitApplyProgress: 'SCM में लागू कर रहा है…',
  msgCommitApplySuccess: 'कमिट संदेश SCM इनपुट में कॉपी किया गया।',
  msgCommitNotGenerated: 'पहले कमिट संदेश बनाएँ।',
  msgRepoNotFound: 'Git रिपॉजिटरी नहीं मिली।',
  msgCancelled: 'उपयोगकर्ता द्वारा रद्द',
  msgDiffEmpty: 'कोई अंतर नहीं मिला। स्टेज की गई फ़ाइलें या बदलाव जांचें।',
  ...
  msgLlmEmptyLocal: 'स्थानीय LLM प्रतिक्रिया खाली थी।',
  msgLocalModelMissing: 'स्थानीय मॉडल डाउनलोड नहीं किया गया है।',
  msgLocalModelDownloadComplete: 'स्थानीय मॉडल डाउनलोड हो गया।',
  msgLocalModelDownloadFailed: 'स्थानीय मॉडल डाउनलोड करने में विफल: {detail}',
  msgLocalModelDownloadCancelled: 'स्थानीय मॉडल डाउनलोड रद्द किया गया।',
  msgLocalModelDeleted: 'स्थानीय मॉडल हटाया गया।',
  msgLocalRuntimeMissing: 'llama.cpp runtime नहीं मिला। commitMaker.localRuntimePath या बंडल binaries जाँचें।',
  msgLocalServerStartFailed: 'स्थानीय LLM सर्वर शुरू करने में विफल: {detail}',
  ...
  msgUntrackedReadFailed: 'अनट्रैक्ड फ़ाइल पढ़ने में विफल: {path} ({detail})',
  msgUntrackedSkipBinary: 'अनट्रैक्ड फ़ाइल छोड़ी गई (संभावित बाइनरी): {path}',
  ...
  promptGuard: 'उपयोगकर्ता के अनुरोधित प्रारूप और निर्देशों का ठीक-ठीक पालन करें।',
  userInstructionLabel: 'उपयोगकर्ता निर्देश (ज्यों का त्यों):',



  diffSectionStaged: '### स्टेज्ड',
  diffSectionUnstaged: '### अनस्टेज्ड',
  diffSectionUntracked: '### अनट्रैक्ड {path}',
  diffHeading: '# डिफ़'
};
