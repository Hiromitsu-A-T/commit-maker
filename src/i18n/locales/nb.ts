...
const nb: UiStrings = {
  ...
  reasoningLabel: 'Resonneringsinnsats (kun OpenAI)',
  ...
  localModelDownloadButton: 'Last ned modell',
  localModelCancelButton: 'Avbryt',
  localModelDeleteButton: 'Slett',
  localModelTestButton: 'Prøv',
  localModelStatusNotDownloaded: 'Ikke lastet ned',
  localModelStatusDownloading: 'Laster ned',
  localModelStatusReady: 'Klar',
  localModelStatusLoading: 'Laster',
  ...
  includeUnstagedLabel: 'Ta med ikke-klargjorte endringer',
  includeUntrackedLabel: 'Ta med usporede filer',
  ...
  providerDescriptionCodex: 'Bruker Commit Makers dedikerte Codex CLI-autentisering.',
  providerDescriptionLocal: 'Bruker den medfølgende llama.cpp-runtime med en lokal GGUF-modell.',

  codexAuthLabel: 'Codex-autentisering',
  codexAuthReady: 'Codex er innlogget',
  codexAuthReadyShort: 'innlogget',
  codexAuthMissing: 'Codex er ikke innlogget eller ikke installert',
  codexAuthMissingShort: 'ikke innlogget',
  codexAuthHint: 'Bruker Commit Makers dedikerte Codex-autentisering, adskilt fra din vanlige Codex CLI-innlogging.',
  codexAuthLoginButton: 'Logg inn',
  codexAuthRefreshButton: 'Oppdater',
  codexAuthLogoutButton: 'Logg ut',
  ...
  msgCodexLoginTerminalOpened: 'Commit Makers dedikerte Codex-innlogging ble startet i terminalen. Status oppdateres automatisk etter innlogging.',
  msgCodexLoginFailed: 'Kunne ikke starte Codex-innlogging: {detail}',
  msgCodexLogoutComplete: 'Logget ut av Commit Makers dedikerte Codex-autentisering.',
  msgCodexLogoutFailed: 'Kunne ikke logge ut av Codex: {detail}',
  ...
  msgDiffEmpty: 'Ingen forskjell funnet. Sjekk klargjorte filer eller endringer.',
  ...
  msgLlmEmptyLocal: 'Svaret fra lokal LLM var tomt.',
  msgLocalModelMissing: 'Den lokale modellen er ikke lastet ned.',
  msgLocalModelDownloadComplete: 'Den lokale modellen er lastet ned.',
  msgLocalModelDownloadFailed: 'Kunne ikke laste ned den lokale modellen: {detail}',
  msgLocalModelDownloadCancelled: 'Nedlasting av lokal modell ble avbrutt.',
  msgLocalModelDeleted: 'Den lokale modellen ble slettet.',
  msgLocalRuntimeMissing: 'llama.cpp-runtime ble ikke funnet. Sjekk commitMaker.localRuntimePath eller de medfølgende binærfilene.',
  msgLocalServerStartFailed: 'Kunne ikke starte lokal LLM-server: {detail}',
  ...
  msgUntrackedReadFailed: 'Kunne ikke lese usporet fil: {path} ({detail})',
  msgUntrackedSkipBinary: 'Usporet fil hoppet over (mistenkt binær): {path}',
  ...
  promptGuard: 'Følg brukerens ønskede format og instruksjoner nøyaktig.',
  userInstructionLabel: 'Brukerinstruksjoner (ordrett):',



  diffSectionStaged: '### Klargjort',
  diffSectionUnstaged: '### Ikke klargjort',
  diffSectionUntracked: '### Usporet {path}',
  diffHeading: '# Forskjell'
};
